...
torchrun --nproc-per-node 4 -m apps.attamba.train config=apps/attamba/configs/debug.yaml
CUDA_VISIBLE_DEVICES=0 python -m  apps.attamba.train config=apps/attamba/configs/debug.yaml
