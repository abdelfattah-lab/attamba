...
from apps.attamba.attamba import (
    LMAttamba,
    LMAttambaArgs,
...
class TrainArgs:
    ...
    model: LMAttambaArgs = field(default_factory=LMAttambaArgs)
